// This code was learnt from Hollistic3d https://youtu.be/dycHQFEz8VI
...
class Chunk
{
    ...
    public Chunk(GameObject c, float cTime)
    {
        chunk = c;
        creationTime = cTime;
    }
...
public class InfiniteTerrain : MonoBehaviour {
    ...
    public GameObject plane;    // the plane mesh to use
    public GameObject player;   // need to know where player is in order to generate more terrain

    int planeSize = 50;     // need to know plane size so can match chunks up together
    int radius = 8;     // radius at which new chunks spawn
    ...
    Hashtable chunks = new Hashtable();
     ...
     void Start()
     {
        ...
        xOffset = Random.Range(-100000, 100000);    //use random sample of perlin noise
